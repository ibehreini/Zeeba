...
// the build instead of letting it deploy half-configured.
for (const required of ['_redirects', '_headers', path.join('.well-known', 'apple-app-site-association')]) {
...
console.log('post-export: wrote dist/404.html, verified _redirects/_headers/.well-known');
